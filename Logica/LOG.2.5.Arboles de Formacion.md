...
![Árbol de formación](LOG.2.5.fa.png)
...
![Subfórmula de la proposición](LOG.2.5.fb.png)
La conjunción es el conectivo que queda fuera
#### 2.2.Análisis de Propiedad
![Análisis de propiedad con paréntesis FBF](LOG.2.5.fc.png)
#### 2.3.Ejercicio Árbol de formación
[En referencia al ejercicio 3 de la clase 2.2.1](<LOG.2.3.Ejercicios Morfologia.md>)
...
![Ejercicio Resuelto por Árbol de Formación](LOG.2.5.fd.png)